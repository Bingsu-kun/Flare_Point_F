  ...
  methods: {
    ...
    autoLogin: async function() {
      try {
        await axios({
          method: 'GET',
          url: 'https://3.34.252.182:8080/fisher/me',
    ...
    login: async function() {
      ...
      if (this.principal === null || this.credentials === null) {
        ...
        try {
          await axios({
            method: 'POST',
            url: 'https://3.34.252.182:8080/fisher/login',
    ...
    signup: async function() {
      ...
      // email 또는 닉네임 중복 체크 안했을 때.
        ...
        try {
          await axios({
            method: 'POST',
            url: 'https://3.34.252.182:8080/fisher/join',
    ...
    emailCheck: async function() {
      ...
      try {
        await axios({
          method: 'POST',
          url: 'https://3.34.252.182:8080/fisher/join/email/exists',
    ...
    nameCheck: async function() {
      ...
      if (this.name.trim().length < 2 || this.name.trim().length > 10) {
        ...
        await axios({
          method: 'POST',
          url: 'https://3.34.252.182:8080/fisher/join/name/exists',
